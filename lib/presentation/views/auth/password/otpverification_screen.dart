  ...
  Future<void> _handleVerifyOtp() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        GoRouter.of(context).go('/reset-password/${widget.email}');
      }
    } catch (e) {
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: authViewModel.isLoading ? null : _handleVerifyOtp,
                              ...
                              const SizedBox(height: 16),
                              TextButton(
                                onPressed: authViewModel.isLoading ? null : _handleResendOtp,
                                child: const Text(
                                  'Resend Code',
                                  style: TextStyle(
                                    color: Colors.blue,
